                ...
                <div className="md:col-span-5 lg:col-span-4">
                    <div className="relative w-full max-w-xs mx-auto aspect-[3/4] md:max-w-sm">
                        ...
                        {selectedGender === 'female' ? (
                            ...
                            <ServiceArea position="top-[50%] left-1/2 -translate-x-1/2" label="Low Body Services" onClick={() => handleAreaClick('low', 'Female Low Body Services')} />
                            </>
                        ) : (
                             <>
                            ...
                            <ServiceArea position="top-[48%] left-1/2 -translate-x-1/2" label="Low Body Services" onClick={() => handleAreaClick('low', 'Male Low Body Services')} />
                            </>
                        )}
                    </div>
                </div>
